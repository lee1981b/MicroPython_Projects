...
* A small collection of MicroPython projects, included are a small collection of projects from the 
...
## Project Uploading:
* Upload individual projects to the ESP32 boards. The following command will copy only the files needed 
for that project.
```bash
mpremote cp boot.py :
mpremote cp main.py :
